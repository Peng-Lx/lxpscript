...
[rewrite_local]
# > Style Art解锁永久会员
^https?:\/\/api-aidraw\.3dmoxiu\.com\/v4\/aidraw\/user\/userInfo\/getUserInfoByToken$ url script-response-body 
*******************************
hostname = api-aidraw.3dmoxiu.com
*******************************
Surge&loon
[Script]
http-response ^https?:\/\/api-aidraw\.3dmoxiu\.com\/v4\/aidraw\/user\/userInfo\/getUserInfoByToken$ requires-body=1,max-size=0,script-path=
